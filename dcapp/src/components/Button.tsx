...
export const Button = ({ dark, white, text, icon, size }: Partial<Props>) => {
  let classes = `py-2 px-6 rounded-full font-sans transition-colors duration-300 ease-in-out border border-zinc-900 h-10 inline-block text-center ${size ? size : "w-fit"}`
