  ...
  return (
    <div className="flex gap-1 bg-zinc-900 w-full h-[700px]  p-1 rounded-2xl font-sans font-grey-500 overflow-hidden">
      <div className="flex flex-col gap-1 w-full h-full rounded-2xl ">
        ...
        <div className="flex flex-col-reverse md:flex-row  bg-gray-300 w-full h-4/6 rounded-2xl ">
          <div className="flex flex-col items-center md:items-start gap-4 md:gap-0 justify-between w-full md:w-1/2 p-5 md:p-10">
            <p className="text-4xl text-center md:text-left">Visualiza el mañana que deseas y comienza a construirlo hoy.</p>
            <Button white text="Conocer proyectos" icon="👋" />
          </div>
          <div className=" w-full md:w-1/2 p-1 overflow-hidden">
            <Image src={img2} alt="" width={0} height={0} className="bg-gray-300 w-full h-full object-cover rounded-2xl" />
          </div>
        </div>

      </div>
      <div className="hidden md:flex flex-col gap-1 w-full h-full rounded-2xl">
